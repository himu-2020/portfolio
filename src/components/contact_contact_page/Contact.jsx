            ...
            <div className="flex justify-between flex-wrap gap-10">
                ...
                <div className="  md:w-3/5 w-full">
                    ...
                    <div className=" text-[#ABB2BF] font-medium">
                        I’m interested in FrontEnd opportunities. However, if you have other request or question, don’t hesitate to contact me
                    </div>
                </div>
                {/* right side */}
                <div className=" flex gap-3">
                    ...
                    <div className=" p-4 border border-[#ABB2BF]">
                        ...
                        <span className='text-[#ABB2BF]'>himu089878787</span>
                    </div>
                    {/* 2 */}
                    <div className=" p-4 border border-[#ABB2BF]">
